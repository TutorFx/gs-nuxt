<template>
  <v-responsive :aspect-ratio="$vuetify.breakpoint.mobile ? 0.7:1">
    <swiper ref="mySwiper" :options="swiperOptions" class="fill-height third">
      <swiper-slide v-for="(content, i) in testi" :key="i" class="fill-height">
